...
class Trainer(object):
    ...
    def save_iamge(self, i, image, pred):
        import scipy.misc
        ...
        tp = np.where(np.logical_and(y_pred_idx == 15, y_pred_idx == 15))
        ...
        mask_result[tp[0], tp[1], :] = 0, 255, 0
        # mask_result[fp[0], fp[1], :] = 0, 0, 255
        # mask_result[fn[0], fn[1], :] = 255, 0, 0
    ...
    def validation(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # image = image.resize((513, 513), Image.BILINEAR)
            ...
            self.save_iamge(i, image[0], pred[0])
